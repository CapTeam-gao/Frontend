...
const surveySections = [
    {
        step: "STEP 1",
        title: "해커톤 팀 매칭 기준 수집",
        description:
            "이 설문은 해커톤 팀을 구성하기 위한 기본 자료로 사용됩니다. 희망 직군, 기술 스택, 구현 경험을 바탕으로 팀 안에서 바로 맡을 수 있는 역할을 확인합니다.",
    },
    {
        step: "STEP 2",
        title: "해커톤 협업 성향 설계",
        description:
            "무박2일 해커톤 상황에 맞춰 아이디어 정리, 소통, 역할 유연성, 시간 압박 대응, 집중 유지처럼 짧은 시간 안에 함께 결과물을 만들 때 중요한 요소를 확인합니다.",
    },
    {
        step: "STEP 3",
        title: "해커톤 팀 매칭 반영 방식",
        description:
            "입력한 성향 점수는 팀 배정의 절대 기준이 아니라 기술 정보와 함께 참고됩니다. 역할, 기술 스택, 발표 가능성, 실행 성향을 함께 고려해 해커톤 팀 구성을 돕습니다.",
    },
];
        ...
        <main className={styles.page}>
            <section className={styles.intro}>
                ...
                <p className={styles.description}>
                    <span>설문 결과는 해커톤 팀을 구성하는 데 사용됩니다.</span>
                    <span>
                        입력한 기술 정보와 해커톤 협업 성향을 함께 분석해 역할과
